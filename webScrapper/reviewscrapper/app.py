...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            db = dbConn['reviewsCrawlerDatabase'] # connecting to the database called crawlerDB
            reviews = list(db[searchString].find({})) # searching the collection with the name same as the keyword
